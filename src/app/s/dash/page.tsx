        ...
        <BasePage>
            ...
            <Tabs defaultValue="account" >
                <TabsList className="w-[400px]">
                    <TabsTrigger className="mx-2" value="account"><Typography variant="h5">Your Leads</Typography></TabsTrigger>
                    <TabsTrigger value="password"><Typography variant="h5">Your Stats</Typography></TabsTrigger>
                </TabsList>
